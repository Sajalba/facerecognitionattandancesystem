...
class FrontPage:
    def __init__(self, root):
        ...
        # Top Title
        self.title = Label(self.top_frame, text="FACIAL RECOGNIZATION ATTENDANCE SYSTEM", bg="#0c2454", fg="#87a81b",height="3", font='Algerian 37 bold underline', width=36, padx=20)
