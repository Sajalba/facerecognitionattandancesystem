...
class FrontPage:
    def __init__(self, root):
        ...
        #Code for about
        self.bottom_frame = Frame(self.root, bg="#0c2454")
        ...
        self.bottomlb2 = Label(self.bottom_frame, text="Sajal Bansal", wraplength=100, width=11, justify=LEFT, anchor="w", font='Arial 11 bold', bg="#0c2454", fg="White", )
